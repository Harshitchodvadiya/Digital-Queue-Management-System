...
const StaffList = () => {
  ...
  // Group staff members by service name and count
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-6">
          ...
          {loading ? (
            ...
            <>
              {/* Display Staff Count by Service */}
              <div className="mb-6">
                <h3 className="text-xl font-semibold mb-2">Staff Count by Service</h3>
                <table className="min-w-full bg-white border border-gray-200 shadow-md rounded-lg">
                  <thead>
                    <tr className="bg-gray-200 text-gray-700 border">
                      <th className="py-2 px-4 border">Service Name</th>
                      <th className="py-2 px-4 border">Number of Staff</th>
                    </tr>
                  </thead>
                  <tbody>
                    {Object.entries(staffByService).map(([serviceName, count]) => (
                      <tr key={serviceName} className="text-center border">
